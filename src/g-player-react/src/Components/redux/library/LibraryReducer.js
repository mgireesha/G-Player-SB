...
import { FETCH_SONGS_START, FETCH_SONGS_SUCCESS, 
            ...
            LIBRARY_FETCH_ALBUM_ARTIST_LIST_SUCCESS, LIBRARY_FETCH_ALBUM_IMGS_START, 
            LIBRARY_FETCH_ALBUM_IMGS_SUCCESS, LIBRARY_FETCH_ALBUM_LIST_OF_AA_START, 
            LIBRARY_FETCH_ALBUM_LIST_OF_AA_SUCCESS, LIBRARY_FETCH_ALBUM_START, LIBRARY_FETCH_ALBUM_SUCCESS, 
            ...
            LIBRARY_SAVE_MUSIC_PATH_START, LIBRARY_SAVE_MUSIC_PATH_SUCCESS, LIBRARY_SEARCH_BY_KEY_START, 
            LIBRARY_SEARCH_BY_KEY_SUCCESS, SET_GROUP_BAND, SET_SHOW_TRACK_ACTIONS_POPUP 
...
const libraryReducer = (state = initialState, action) => {
    switch(action.type){
        ...
        case SET_GROUP_BAND:
            ...
            case SET_SHOW_TRACK_ACTIONS_POPUP:
                    return{
                        ...state,
                        showTrackPopup: action.showTrackPopup
                    }
        default:
            return {
                ...state,
