...
import { FETCH_SONGS_START, FETCH_SONGS_SUCCESS, 
        ...
        LIBRARY_FETCH_SONGS_BY_ARTIST_START, LIBRARY_FETCH_SONGS_BY_ARTIST_SUCCESS, LIBRARY_INIT_BUILD_LIBRARY_START, LIBRARY_INIT_BUILD_LIBRARY_SUCESS, LIBRARY_SAVE_MUSIC_PATH_START, LIBRARY_SAVE_MUSIC_PATH_SUCCESS, LIBRARY_SEARCH_BY_KEY_START, LIBRARY_SEARCH_BY_KEY_SUCCESS, SET_GROUP_BAND, SET_SHOW_TRACK_ACTIONS_POPUP 
...
export const setShowTrackActionsPopup = (showTrackPopup) => ({
    type: SET_SHOW_TRACK_ACTIONS_POPUP,
    showTrackPopup
})
