...
import { A_TO_Z, SORT_ARTIST, SORT_YEAR } from "../redux/GPActionTypes";
...
export const AlbumList = () => {
    ...
    return(
        <>
            <SortingContainer sortListKeys={albumListKeys} setSortBy={setSortBy} sortBy={sortBy} sortSelectors={[A_TO_Z,SORT_YEAR,SORT_ARTIST]} />
